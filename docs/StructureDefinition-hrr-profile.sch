...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      <sch:assert test="count(f:extension[@url = 'http://example.org/StructureDefinition/interpretation-certainty']) &lt;= 1">extension with URL = 'http://example.org/StructureDefinition/interpretation-certainty': maximum cardinality of 'extension' is 1</sch:assert>
